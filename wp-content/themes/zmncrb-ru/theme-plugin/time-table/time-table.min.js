...
$(function () {
    ...
    $(document).ready(function () {
        $('.doc_link_ajax').on('click', function () {
            ...
            var tt_disabled = $(this).attr("tt_disabled");
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (tt_disabled != 1) {
                        $('.time-table-time-board #tt_card_table_disabled').css({'visibility' : 'hidden'});     
                        var queryArr = [];
                    ...
                    $('.time-table-time-board #tt_card_table_disabled').css({'visibility' : 'visible'});          
                    }
                }
            });
        });
