...
function zmncrb_ru_scripts() {
	...
	wp_enqueue_script( 'home-page-slider.js', get_template_directory_uri() . '/slider/home-page-slider.js', array(), '', true );
	
	wp_enqueue_style( 'home-page-slider.css', get_stylesheet_directory_uri() . '/slider/home-page-slider.css');
 ...
 * Time-table module.
 */
require get_template_directory() . '/theme-plugin/time-table/time-table.php';
