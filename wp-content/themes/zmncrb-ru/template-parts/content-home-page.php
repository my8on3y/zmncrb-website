...
<section class="landing-carousel">
	...
	<div class="control-panel">
		<a href="#" class="-control-panel_button"><i class="fa fa-headset"></i> Записаться на приём</a>
		<a href="<?php echo get_page_by_path( '/time-table-page' ) -> guid ?>" class="-control-panel_button"><i class="fa fa-clock"></i>
	...
	<div class="main-central-slider">
		<?php require get_template_directory() . '/slider/home-page-slider.php'; ?>
	</div>
</section>

<section class="panel_2 __section-bottom-margin">
	<div class="control-panel">
		<a href="#" class="-control-panel_button"><i class="fa fa-headset"></i> Записаться на приём</a>
		<a href="<?php echo get_page_by_path( '/time-table-page' ) -> guid ?>" class="-control-panel_button"><i class="fa fa-clock"></i>
			Расписание приёмов</a>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-block">
						<h2><i class="fa fa-asterisk"></i><span class="-a-word"> Змеиногорская</span> Центральная Районная Больница <i
							 class="fa fa-asterisk"></i></h2>
						<p>Краевое государственное бюджетное учреждение здравоохранения <span class="-a-word">"Центральная Районная
								Больница города Змеиногорска"</span><small><br><a href="#">( Лицензия № ЛО–22–01–004898 от 23.03.18 г.)</a></small>
...
<?php require get_template_directory() . '/news-posts.php'; ?>
<?php require get_template_directory() . '/ads-posts.php'; ?>
<!-- Информация о составе -->
<section class="include-inform __section-bottom-margin" data-scroll="once" data-scroll-showCallback="triggerStartNum()">
	<div class="container">
		<div class="__section-separator">
			<h3 class="-a-word __decor-line-in-headline"><i class="fa fa-clipboard-list"></i> Состав ЦРБ</h3>
		</div>
		<div class="row">
			<table class="text-center" s>
				...
				<tr>
					<td><span id="informNum1" style="font-size: 20pt; color: #29b6f6"></span> койка</td>
					...
					<td><span id="informNum6" style="font-size: 20pt; color: #29b6f6"></span></td>
				</tr>
			</table>
		</div>
	</div>
...
<section class="organisation-work-time __section-bottom-margin">
	<div class="container">
		<div class="__section-separator">
			<h3 class="__decor-line-in-headline"><i class="fa fa-clipboard-list"></i><span class="-a-word"> Режим</span> работы</h3>
		</div>
		<div class="row">
			<div class="col-lg-12">
				<table class="" align="left" style="width: 100%;">
					<tr align="left">
						<th><i class="fa fa-hospital" style="color: #D93240;"></i> Отделение</th>
						<th><i class="fa fa-clock" style="color: #D93240;"></i> Режим работы</th>
					</tr>
					<tr>
						<td>Стационар</td>
						<td>круглосуточно</td>
...
<section class="yandex-map  __section-bottom-margin">
	<div class="container">
		<div class="__section-separator">
			<h3 class="__decor-line-in-headline"><i class="fa fa-map"></i><span class="-a-word"> Схема</span> проезда</h3>
		</div>
	</div>
	<div class="map">
		<div class="container">
			<div class="row">
				<div class="col-lg-8"><iframe id="yandex-map" src="https://yandex.ru/map-widget/v1/-/CBB9IZtQ0B" width="100%"
					 height="400" frameborder="1" allowfullscreen="true" style="border: none;"></iframe></div>
				<div class="col-lg-4">
					<ul>
						<h3>Схема проезда</h3>
